"""s001 - plot STARSS method 1 (exp001).

Runs ``exp001`` and plots the pulse scheme, the detector signals, and the
time-resolved anisotropy.

Run:  python scripts/experiments/s001_starss_method1.py
"""
...
def main(params: experiment = None):
    ...
    plt.title('STARSS method 1 - pulse scheme')
    ...
    ax0.legend()
    ax0.set_title('STARSS method 1 (rsEGFP2)')
