...
# Count conversion
# ----------------------------------------------------------------------------
def detected_counts(signals, n_molecules, collection_efficiency, lifetime, dt):
...
# ----------------------------------------------------------------------------
def background_subtract(channels, backgrounds=None, background_averages=1):
    ...
    backgrounds : array_like, optional
        Measured background counts, [parallel, perpendicular]. ``None`` (default)
        means no background (zeros), recovering pure shot noise.
    ...
    if backgrounds is None:
        backgrounds = np.zeros_like(channels)
    else:
...
# ----------------------------------------------------------------------------
def counts_snr(channels, backgrounds=None, background_averages=1):
...
def anisotropy_snr(channels, backgrounds=None, background_averages=1):
...
def polarization_snr(channels, backgrounds=None, background_averages=1):
